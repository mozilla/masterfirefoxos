...
;(function() {
    ...
    function showFeedback(submitElement) {
        ...
        var correctFeedback = nextElementSiblingMatching(question, '.correct-feedback');
        var incorrectFeedback = nextElementSiblingMatching(question, '.incorrect-feedback');
        var partlyFeedback = nextElementSiblingMatching(question, '.partly-correct-feedback');
